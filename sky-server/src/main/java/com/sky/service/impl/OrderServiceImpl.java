...
public class OrderServiceImpl implements OrderService {
    ...
    private static final Integer CONFIRMED_ORDER = 3;
    private static final Integer CANCEL_ORDER = 6;
    private static final Integer COMPLETE_ORDER = 5;
    private static final Integer REJECTION_ORDER = 8;
    private static final Integer DELIVERY_ORDER = 4;
...
//    }
        ...
        orderMapper.updateStatus(OrderStatus, OrderPaidStatus, check_out_time, byNumber.getId());
...
//        webSocketServer.sendToAllClient(jsonString);
     ...
     */
    @Override
    public PageResult list(OrdersPageQueryDTO queryDTO) {
    ...
    public void confirm(OrdersConfirmDTO confirmDTO) {
        // 接单就是修改当前订单状态
        Orders orders = new Orders();
        orders.setStatus(CONFIRMED_ORDER);
    ...
    public void rejection(OrdersRejectionDTO rejectionDTO) {
        ...
        orders.setStatus(REJECTION_ORDER);
        orderMapper.setStatus(orders);
    }
    ...
    public void complete(Long id) {
        Orders orders = new Orders();
        orders.setStatus(COMPLETE_ORDER);
    ...
    public void delivery(Long id) {
        Orders orders = new Orders();
        orders.setStatus(DELIVERY_ORDER);
    ...
    public void reminder(Long id) {
        ...
        // 转化为json 调用websocket向客户端浏览器发送消息
        String jsonString = JSON.toJSONString(map);
        webSocketServer.sendToAllClient(jsonString);
    }
